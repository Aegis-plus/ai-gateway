...
export const MODEL_CATALOG: ModelEntry[] = [
  ...
  { id: 'kiro/claude-3-7-sonnet', provider: 'kiro', upstream: 'claude-3.7-sonnet', description: 'Kiro · Claude 3.7 Sonnet' },
  { id: 'kiro/claude-3.7-sonnet', provider: 'kiro', upstream: 'claude-3.7-sonnet', description: 'Kiro · Claude 3.7 Sonnet' },
  { id: 'kiro/claude-3-7-sonnet-thinking', provider: 'kiro', upstream: 'claude-3.7-sonnet-thinking', description: 'Kiro · Claude 3.7 Sonnet (Thinking)' },
  { id: 'kiro/claude-3.7-sonnet-thinking', provider: 'kiro', upstream: 'claude-3.7-sonnet-thinking', description: 'Kiro · Claude 3.7 Sonnet (Thinking)' },
  { id: 'kiro/claude-3-7-sonnet-20250219', provider: 'kiro', upstream: 'claude-3.7-sonnet', description: 'Kiro · Claude 3.7 Sonnet' },
  { id: 'kiro/claude-3-5-sonnet', provider: 'kiro', upstream: 'claude-3.5-sonnet', description: 'Kiro · Claude 3.5 Sonnet' },
  { id: 'kiro/claude-3.5-sonnet', provider: 'kiro', upstream: 'claude-3.5-sonnet', description: 'Kiro · Claude 3.5 Sonnet' },
  { id: 'kiro/claude-3-5-sonnet-20241022', provider: 'kiro', upstream: 'claude-3.5-sonnet', description: 'Kiro · Claude 3.5 Sonnet' },
  { id: 'kiro/claude-3-5-sonnet-20240620', provider: 'kiro', upstream: 'claude-3.5-sonnet', description: 'Kiro · Claude 3.5 Sonnet' },
  { id: 'kiro/claude-3-5-sonnet-latest', provider: 'kiro', upstream: 'claude-3.5-sonnet', description: 'Kiro · Claude 3.5 Sonnet' },
  { id: 'kiro/claude-3-5-haiku', provider: 'kiro', upstream: 'claude-3.5-haiku', description: 'Kiro · Claude 3.5 Haiku' },
  { id: 'kiro/claude-3.5-haiku', provider: 'kiro', upstream: 'claude-3.5-haiku', description: 'Kiro · Claude 3.5 Haiku' },
  { id: 'kiro/claude-3-5-haiku-20241022', provider: 'kiro', upstream: 'claude-3.5-haiku', description: 'Kiro · Claude 3.5 Haiku' },
  { id: 'kiro/claude-3-haiku', provider: 'kiro', upstream: 'claude-3-haiku', description: 'Kiro · Claude Haiku' },
  { id: 'kiro/claude-3-opus', provider: 'kiro', upstream: 'claude-3-opus', description: 'Kiro · Claude 3 Opus' },
  { id: 'kiro/claude-3-opus-20240229', provider: 'kiro', upstream: 'claude-3-opus', description: 'Kiro · Claude 3 Opus' },
  ...
  { id: 'kiro/gpt-5', provider: 'kiro', upstream: 'gpt-5', description: 'Kiro · GPT 5' },
  { id: 'kiro/gpt-5-mini', provider: 'kiro', upstream: 'gpt-5-mini', description: 'Kiro · GPT 5 Mini' },

  // ---- OpenAI GPT 4.x & Reasoning Series on Kiro ----
  { id: 'kiro/gpt-4.5', provider: 'kiro', upstream: 'gpt-4.5', description: 'Kiro · GPT 4.5' },
  { id: 'kiro/gpt-4.5-preview', provider: 'kiro', upstream: 'gpt-4.5-preview', description: 'Kiro · GPT 4.5 Preview' },
  { id: 'kiro/gpt-4o', provider: 'kiro', upstream: 'gpt-4o', description: 'Kiro · GPT-4o' },
  { id: 'kiro/gpt-4o-mini', provider: 'kiro', upstream: 'gpt-4o-mini', description: 'Kiro · GPT-4o Mini' },
  { id: 'kiro/gpt-4-turbo', provider: 'kiro', upstream: 'gpt-4-turbo', description: 'Kiro · GPT-4 Turbo' },
  { id: 'kiro/gpt-4', provider: 'kiro', upstream: 'gpt-4', description: 'Kiro · GPT-4' },
  { id: 'kiro/o3-mini', provider: 'kiro', upstream: 'o3-mini', description: 'Kiro · o3-mini' },
  { id: 'kiro/o3', provider: 'kiro', upstream: 'o3', description: 'Kiro · o3' },
  { id: 'kiro/o1', provider: 'kiro', upstream: 'o1', description: 'Kiro · o1' },
  { id: 'kiro/o1-mini', provider: 'kiro', upstream: 'o1-mini', description: 'Kiro · o1-mini' },
  { id: 'kiro/o1-preview', provider: 'kiro', upstream: 'o1-preview', description: 'Kiro · o1-preview' },
  ...
  { id: 'kiro/deepseek-v3', provider: 'kiro', upstream: 'deepseek-v3', description: 'Kiro · DeepSeek V3' },
  { id: 'kiro/deepseek-r1', provider: 'kiro', upstream: 'deepseek-r1', description: 'Kiro · DeepSeek R1 (Thinking)' },
  { id: 'kiro/deepseek-coder', provider: 'kiro', upstream: 'deepseek-coder', description: 'Kiro · DeepSeek Coder' },
  { id: 'kiro/qwen3-coder-next', provider: 'kiro', upstream: 'qwen3-coder-next', description: 'Kiro · Qwen3 Coder Next (text only)' },
  { id: 'kiro/qwen-2.5-coder-32b', provider: 'kiro', upstream: 'qwen-2.5-coder-32b', description: 'Kiro · Qwen 2.5 Coder 32B' },
  { id: 'kiro/qwen-2.5-coder', provider: 'kiro', upstream: 'qwen-2.5-coder', description: 'Kiro · Qwen 2.5 Coder' },
  { id: 'kiro/glm-5', provider: 'kiro', upstream: 'glm-5', description: 'Kiro · GLM 5' },
  { id: 'kiro/glm-4-plus', provider: 'kiro', upstream: 'glm-4-plus', description: 'Kiro · GLM 4 Plus' },
  { id: 'kiro/minimax-m2.5', provider: 'kiro', upstream: 'MiniMax-M2.5', description: 'Kiro · MiniMax M2.5' },
  { id: 'kiro/minimax-01', provider: 'kiro', upstream: 'minimax-01', description: 'Kiro · MiniMax 01' },
  { id: 'kiro/mistral-large', provider: 'kiro', upstream: 'mistral-large', description: 'Kiro · Mistral Large' },
  { id: 'kiro/mistral-codestral', provider: 'kiro', upstream: 'mistral-codestral', description: 'Kiro · Mistral Codestral' },
  { id: 'kiro/codestral', provider: 'kiro', upstream: 'codestral', description: 'Kiro · Codestral' },
  ...
  // ---- Gemini 3.x Series ----
  { id: 'agy/gemini-3.7-flash', provider: 'antigravity', upstream: 'gemini-3.7-flash', description: 'Antigravity · Gemini 3.7 Flash' },
  ...
  { id: 'agy/gemini-3.6-flash', provider: 'antigravity', upstream: 'gemini-3.6-flash', description: 'Antigravity · Gemini 3.6 Flash' },
  ...
  { id: 'agy/gemini-3.5-flash', provider: 'antigravity', upstream: 'gemini-3.5-flash', description: 'Antigravity · Gemini 3.5 Flash' },
  { id: 'agy/gemini-3.5-flash-high', provider: 'antigravity', upstream: 'gemini-3.5-flash-high', description: 'Antigravity · Gemini 3.5 Flash (high)' },
  { id: 'agy/gemini-3.5-flash-medium', provider: 'antigravity', upstream: 'gemini-3.5-flash-medium', description: 'Antigravity · Gemini 3.5 Flash (medium)' },
  ...
  { id: 'agy/gemini-3.1-pro', provider: 'antigravity', upstream: 'gemini-3.1-pro', description: 'Antigravity · Gemini 3.1 Pro' },
  { id: 'agy/gemini-3.1-pro-high', provider: 'antigravity', upstream: 'gemini-3.1-pro-high', description: 'Antigravity · Gemini 3.1 Pro (high)' },
  ...
  { id: 'agy/gemini-3-pro', provider: 'antigravity', upstream: 'gemini-3-pro', description: 'Antigravity · Gemini 3 Pro' },
  { id: 'agy/gemini-3.0-pro', provider: 'antigravity', upstream: 'gemini-3.0-pro', description: 'Antigravity · Gemini 3.0 Pro' },
  { id: 'agy/gemini-3-pro-high', provider: 'antigravity', upstream: 'gemini-3-pro-high', description: 'Antigravity · Gemini 3 Pro (high)' },
  { id: 'agy/gemini-3-flash', provider: 'antigravity', upstream: 'gemini-3-flash', description: 'Antigravity · Gemini 3 Flash' },
  { id: 'agy/gemini-3.0-flash', provider: 'antigravity', upstream: 'gemini-3.0-flash', description: 'Antigravity · Gemini 3.0 Flash' },
  ...
  { id: 'agy/gemini-2.0-flash', provider: 'antigravity', upstream: 'gemini-2.0-flash', description: 'Antigravity · Gemini 2.0 Flash' },
  { id: 'agy/gemini-2.0-flash-exp', provider: 'antigravity', upstream: 'gemini-2.0-flash-exp', description: 'Antigravity · Gemini 2.0 Flash (Exp)' },
  { id: 'agy/gemini-2.0-flash-thinking-exp', provider: 'antigravity', upstream: 'gemini-2.0-flash-thinking', description: 'Antigravity · Gemini 2.0 Flash (Thinking Exp)' },
  { id: 'agy/gemini-2.0-pro', provider: 'antigravity', upstream: 'gemini-2.0-pro', description: 'Antigravity · Gemini 2.0 Pro' },
  { id: 'agy/gemini-2.0-pro-exp', provider: 'antigravity', upstream: 'gemini-2.0-pro-exp', description: 'Antigravity · Gemini 2.0 Pro (Exp)' },
  { id: 'agy/gemini-1.5-pro', provider: 'antigravity', upstream: 'gemini-1.5-pro', description: 'Antigravity · Gemini 1.5 Pro' },
  { id: 'agy/gemini-1.5-pro-latest', provider: 'antigravity', upstream: 'gemini-1.5-pro-latest', description: 'Antigravity · Gemini 1.5 Pro (Latest)' },
  { id: 'agy/gemini-1.5-flash', provider: 'antigravity', upstream: 'gemini-1.5-flash', description: 'Antigravity · Gemini 1.5 Flash' },
  { id: 'agy/gemini-1.5-flash-latest', provider: 'antigravity', upstream: 'gemini-1.5-flash-latest', description: 'Antigravity · Gemini 1.5 Flash (Latest)' },
  ...
  { id: 'agy/gpt-oss-120b', provider: 'antigravity', upstream: 'gpt-oss-120b', description: 'Antigravity · GPT-OSS 120B' },
